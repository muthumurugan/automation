...
class ProctorEvaluation:
    def __init__(self):
        write_excel_object.save_result(output_path_dev_proctor_evaluation)
        # 0th Row Header
        header = ['Proctoring Evaluation automation']
        # 1 Row Header
        write_excel_object.write_headers_for_scripts(0, 0, header, write_excel_object.black_color_bold)
        header = ['Testcases', 'Status', 'Test ID', 'Candidate ID', 'Testuser ID', 'Expected device proctoring status',
                  'Actual device proctoring status',
